...
modelo <- lm(Calories_Burned ~ Age + Gender  + Height..m.+ Weight..kg. + Max_BPM + Avg_BPM + Resting_BPM + Session_Duration..hours.+ Calories_Burned + Workout_Type + Fat_Percentage + Water_Intake..liters. + Workout_Frequency..days.week. + Experience_Level + BMI , data = datos)
...
n <- nrow(datos)
p <- length(coef(model))  # Número de parámetros (incluyendo el intercepto)
