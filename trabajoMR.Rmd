...
## Correlación entre Calories_Burned y Variables Predictoras

```{r}
cor_matrix <- cor(train |> select(Age, Weight, Height, Max_BPM, Avg_BPM, Resting_BPM, Session_Duration, Fat_Percentage, Water_Intake, Workout_Frequency, Experience_Level, BMI, Calories_Burned))
